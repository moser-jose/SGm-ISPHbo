...
<html>
	<head>
	 ...
	 <script type="text/javascript">
		 function ___view_GRAFIC__( _v, _c ){ 
			 $('#container').highcharts({
				chart: {
					type: 'areaspline'
				},
				title: {
					text: 'VALOR DAS MATRÍCULAS'
				},
				subtitle: {
					text: '...quantidade de valores recaudados x matrículas feitas no ano'
				},
				xAxis: {
					categories: _c,
				},
       ...
       <!--------------------------------------------------------------------------------------->
        <script type="text/javascript">
		   $(document).ready(function (){ 
				...
				_set_YearBox( 'ano' );
			                                   ___view_GRAFIC__( ___Grafic_cv__(), __get_curso__()[1])   ;			  			  
			  $( '#ano'   ).change(function(){ ___view_GRAFIC__( ___Grafic_cv__(), __get_curso__()[1]) });
		   });
		</script> 
       <!--------------------------------------------------------------------------------------->
       <!--------------------------------------------------------------------------------------->                
