...
<input type="text" value="-" name="id" id="id" style="display: none" />
                    ...
                    <table width="100%">
                      <tr class="tr_color" >
                        <td colspan="3" align="center"><h5 style="margin:4px; color:#000"><b>GESTÃO PROVÍNCIA</b></h5></td>
                      </tr>                                        
					</table> 
                     <br />                                            
	             ...
	             <table width="57%"> 
				 <tr>
                   <td width="20%" align="right"  scope="row"><strong>País:</strong></td>
                   <td width="27%"><select name="Pais_id" type="text" id="Pais_id"></select>
                     <font color="#FF0000">*</font></td>
                 </tr> 
                 <tr>
                   <td width="20%" align="right"  scope="row"><strong>Província:</strong></td>
                   <td width="27%"><input name="provNome" type="text" id="provNome" />
                     <font color="#FF0000">*</font></td>
                 </tr> 
	             </table>
               ...
               <!--ACA SE CREA EL FORM SEGUN EL MENU Y ROL-->          
                  <br />
                   <div style="width: 95%;" >                   
                    <!--bloque pag-->                      
                        <article class="box" > 
                          <h5 style="margin:4px"><b>LISTA PROVÍNCIAS</b></h5>
