	...
	{ ?>
		...
		<script>
			function ___iFrame_Select_(punter) {
				...
				switch (punter) {
					case 1: {
						txt = '<div><iframe src="../_Grafics/Graficas/___view_cs_.php" frameborder="0" width="100%" height="530px"></iframe>';
						break
					}
					case 2: {
						txt = '<div><iframe src="../_Grafics/Graficas/___view_cv_.php" frameborder="0" width="100%" height="490px"></iframe>';
						break
					}
					case 3: {
						txt = '<div><iframe src="../_Grafics/Graficas/___view_um_.php" frameborder="0" width="100%" height="470px"></iframe>';
						break
					}
					case 4: {
						txt = '<div><iframe src="../_Grafics/Graficas/___view_cr_.php" frameborder="0" width="100%" height="470px"></iframe>';
						break
					}
				}
				return txt;
